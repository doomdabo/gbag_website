...
def load_input(pci,azi,down):
    rss_path = 'C:\GBAG_WEB\\web_tuto_GBAG\\gbag\\static\\csv\\maps\\RSS_realmatched.csv'
    ...
    # LAMS 이미지 5x5
    lams_path='C:\GBAG_WEB\\web_tuto_GBAG\\gbag\\static\\lams\\pci'+pci+'_grid_20_20_100_v1'
    ...
    numeric_data_test = pd.read_csv('C:\GBAG_WEB\\web_tuto_GBAG\\gbag\\static\\csv\\test\\grid_5.csv')    # 좌표 파일 읽기
